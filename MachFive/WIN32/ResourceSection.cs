...
namespace Origami.Win32
{
    public class ResourceSection : Section
    {
        ...
        List<ResFont> fonts;
        List<ResFontDir> fontDirectories;
        List<ResCursorGroup> cursorGroups;
        List<ResIconGroup> iconGroups;
        List<ResIcon> icons;
        List<ResMenu> menus;
        List<ResUserData> userData;
        List<ResStringTable> stringtable;
...
//- bitmap --------------------------------------------------------------
    ...
    public class ResBitmap : ResourceData
    {
        ...
        //public ResBitmap(ResourceNode _parent, ResourceParser _parser, int _level, uint _idName)
        //    : base(_parent, _parser, _level, _idName)
        //{
...
//- string table --------------------------------------------------------------
    ...
    public class ResStringTable : ResourceData
    {
        ...
        //public ResString(ResourceNode _parent, ResourceParser _parser, int _level, uint _idName)
        //    : base(_parent, _parser, _level, _idName)
        //{
